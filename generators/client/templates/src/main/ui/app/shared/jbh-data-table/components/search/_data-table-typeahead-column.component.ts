...
export const TYPEAHEAD_CONTROL_VALUE_ACCESSOR:any = {
 // provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => DataTableTypeAheadComponent),
  multi: true
};
@Component({
  selector: 'datatable-typeahead-column',
  template: `
    <div class="typeahead">
      <input #inputElement
...
export class DataTableTypeAheadComponent implements OnInit, ControlValueAccessor {
  abstract;
